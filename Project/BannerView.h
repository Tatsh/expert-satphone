...
/**
 * @brief A grey plate holding one aspect-fill image view, loaded over the network on demand.
 */
@interface BannerView : UIView

/**
 * @brief The image view filling the banner.
 *
...
/**
 * @brief The promotion whose artwork this banner shows.
 *
...
/**
 * @brief Rounds both the banner's own corners and its image view's, to the same radius.
...
/**
 * @brief Starts fetching the promotion's artwork.
 *
