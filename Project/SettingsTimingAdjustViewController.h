...
/**
 * @brief Chains up to @c UIViewController .
...
/**
 * @brief Pauses the preview and flushes @c NSUserDefaults , then chains up.
...
/**
 * @brief Drops the preview view, removes the notification observers, then chains up.
 * @param animated Whether the disappearance is animated.
...
/**
 * @brief Allows portrait and portrait-upside-down only.
...
/**
 * @brief Returns the portrait and portrait-upside-down mask.
...
/**
 * @brief Returns @c YES to permit autorotation.
 * @return @c YES.
...
/**
 * @brief Presents the auto-calibration confirmation alert (Cancel / OK).
...
/**
 * @brief The auto-calibration alert callback: on the OK button, shows the "done" confirmation.
...
/**
 * @brief Drops the preview view and removes the notification observers, then chains up.
 * @ghidraAddress 0x17596c
 */
- (void)dealloc;

/**
 * @brief Slider value-changed action: snaps the slider, maps it to @c delaySector , updates the
...
/**
 * @brief Formats the current slider value into the value label.
 * @ghidraAddress 0x175b04
 */
- (void)refreshValue;

/**
 * @brief Play/pause button action: toggles playback, swaps the button icon, and starts or pauses
...
/**
 * @brief App-suspend notification handler: pauses the animation and preview and forces the paused
 *        state.
...
/**
 * @brief App-resume notification handler: resumes the preview and the animation.
...
/**
 * @brief Background-music-finished notification handler: forces the paused state and stops the
 *        preview.
...
/**
 * @brief Creates the @c CADisplayLink targeting @c -loop: and adds it to the current run loop.
 * @ghidraAddress 0x17606c
 */
- (void)startAnimation;

/**
 * @brief Pauses the display link, if any.
 * @ghidraAddress 0x1761a0
 */
- (void)pauseAnimation;

/**
 * @brief Unpauses the display link, if any.
 * @ghidraAddress 0x176224
 */
- (void)resumeAnimation;

/**
 * @brief Invalidates and clears the display link, if any.
 * @ghidraAddress 0x1762a8
 */
- (void)stopAnimation;

/**
 * @brief Display-link callback: draws one preview frame.
...
/**
 * @brief Builds the theme-prefixed sound-effect resource name for the given base name.
...
/**
 * @brief The display link driving the preview animation.
