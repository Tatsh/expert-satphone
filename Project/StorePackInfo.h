...
/**
 * A pack's identity, name, price, store flags, and track list.
 */
@interface StorePackInfo : NSObject

/**
 * The pack's identifier. Four bytes in the metadata, so @c int.
 * @ghidraAddress 0xbe3d0 (getter)
 */
@property(nonatomic, readonly) int packID;
/** Whether to show the "new" marker. @ghidraAddress 0xbe3e0 (getter) */
@property(nonatomic, readonly) BOOL isNew;
/** Whether to show the "extend" marker. @ghidraAddress 0xbe3f0 (getter) */
@property(nonatomic, readonly) BOOL hasExtend;
/** The pack artwork's address. @ghidraAddress 0xbe400 (getter) */
@property(nonatomic, readonly, nullable) NSString *artworkURL;
/** The pack's display name. @ghidraAddress 0xbe410 (getter) */
@property(nonatomic, readonly, nullable) NSString *packName;
/** The pack's long description. @ghidraAddress 0xbe420 (getter) */
@property(nonatomic, readonly, nullable) NSString *comment;
/** The pack's one-line comment. @ghidraAddress 0xbe430 (getter) */
@property(nonatomic, readonly, nullable) NSString *shortComment;
/** The pack's copyright line. @ghidraAddress 0xbe440 (getter) */
@property(nonatomic, readonly, nullable) NSString *copyright;
/** The related-site link URL string. @ghidraAddress 0xbe450 (getter) */
@property(nonatomic, readonly, nullable) NSString *linkURL;
/** The related-site link title. @ghidraAddress 0xbe460 (getter) */
@property(nonatomic, readonly, nullable) NSString *linkTitle;
/** The pack's tracks, each a @c StoreMusicInfo. @ghidraAddress 0xbe470 (getter) */
@property(nonatomic, readonly, nullable) NSArray *musicInfos;
/** The StoreKit product backing the pack. @ghidraAddress 0xbe480 (getter) */
@property(nonatomic, readonly, nullable) SKProduct *product;
/** The regular (pre-discount) yen price. @ghidraAddress 0xbe490 (getter) */
@property(nonatomic, readonly, nullable) NSDecimalNumber *regularPriceJPY;

/**
 * The formatted price string, or nil when there is no product.
 * @ghidraAddress 0xbd5ac (getter)
 */
@property(nonatomic, readonly, nullable) NSString *priceString;
/**
 * The price styled for display; a struck-through regular price precedes a discounted price.
 * @ghidraAddress 0xbd6b4 (getter)
 */
@property(nonatomic, readonly, nullable) NSAttributedString *attributedPriceString;

/**
 * Builds a pack from a store dictionary and its StoreKit product.
...
/**
 * The best artwork URL for the current device from a pack dictionary.
 *
...
/**
 * Fills the pack from a store list dictionary.
 * @param dictionary The pack dictionary.
...
/**
 * Fills the pack's detail-only fields from a detail dictionary, keeping any already set.
...
/**
 * Builds the track list from an array of track dictionaries, unless it is already set.
