/**
 * @file
 * A store genre model describing one pack-list genre: its display name, identifier, banner
...
/**
 * Build a genre with a display name, identifier, banner image address, and colour string.
 * @param name The genre display name.
 * @param genreID The genre identifier.
...
/**
 * Whether the string is present and not empty.
...
/**
 * Fill the genre's banner image, colours, description, and heading image from an extend-info
...
/**
 * The accumulated packs for this genre.
...
/**
 * The pack at the given index, or @c nil when out of range.
...
/**
 * Append a fetched page of packs to the genre.
...
/**
 * Set the genre description from a dictionary's @c Comment entry when present.
...
/**
 * Copy genre data from another genre. A no-op in the shipped binary.
