...
/**
 * The advert-delegate callbacks the @c ApplilinkCore fan-out methods dispatch through
...
/**
 * The advert list failed to load.
 * @param error The failure.
 */
- (void)appListFailLoadWithError:(nullable NSError *)error;
/**
 * The advert list failed to load, with request parameters.
 * @param error The failure.
 * @param appParam The parameters the request was made with.
 */
- (void)appListFailLoadWithError:(nullable NSError *)error
         withApplilinkParameters:(nullable ApplilinkParameters *)appParam;
/**
 * The advert list failed.
 * @param error The failure.
 */
- (void)appListFailWithError:(nullable NSError *)error;
/**
 * The advert list failed, with request parameters.
 * @param error The failure.
 * @param appParam The parameters the request was made with.
 */
- (void)appListFailWithError:(nullable NSError *)error
     withApplilinkParameters:(nullable ApplilinkParameters *)appParam;
/**
 * The advert list failed to link.
 * @param error The failure.
 */
- (void)appListFailLinkWithError:(nullable NSError *)error;
/**
 * The advert list failed to link, with request parameters.
 * @param error The failure.
 * @param appParam The parameters the request was made with.
 */
- (void)appListFailLinkWithError:(nullable NSError *)error
         withApplilinkParameters:(nullable ApplilinkParameters *)appParam;
/** Advert sound use started. */
- (void)appListSoundUseStart;
/** Advert sound use finished. */
- (void)appListSoundUseFinish;
/** An advert movie finished. */
...
/**
 * Resume the SDK core, closing any open store and video view and re-initialising from
 * persisted state.
...
/**
 * Reset the SDK core's cached initialisation state and the DAU counter.
...
/**
 * Flag the SDK as used inside the store. The selector reads @c unused, but the binary sets
...
/**
 * The current UDID, preferring the advertising UDID when advertising tracking is available.
...
/**
 * The UDID, computing and caching it from the pasteboard on first access.
...
/**
 * The pasteboard UDID, computing and caching it from the old pasteboard slot on first
 * access.
...
/**
 * Clear the stored UDID and, outside the default environment, its keychain records.
...
/**
 * Clear the advertising-UDID keychain records outside the default environment.
...
/**
 * Report the start of advert sound use back to a delegate, latching the sound and movie
 * flags.
 * @param delegate The advert delegate to notify.
...
/**
 * Report the finish of advert sound use back to a delegate, once sound use has started.
 * @param delegate The advert delegate to notify.
...
/**
 * Report the finish of an advert movie back to a delegate, once a movie is playing.
 * @param delegate The advert delegate to notify.
...
/**
 * Save the device info and post it to the analytics endpoint.
 * @ghidraAddress 0x24465c
 */
+ (void)collectDeviceInfoCore;

/**
 * Collect the OpenGL, memory, screen, and CPU details and persist them to @c NSUserDefaults.
 * @ghidraAddress 0x2446a4
 */
+ (void)saveDeviceInfo;

/**
 * The persisted device-information dictionary.
...
/**
 * A hardware @c sysctl integer for a @c CTL_HW selector.
...
/**
 * The CPU frequency in hertz, from the @c HW_CPU_FREQ @c sysctl.
...
/**
 * The number of CPUs, from the @c HW_NCPU @c sysctl.
...
/**
 * The physical memory size in bytes, from the @c HW_PHYSMEM @c sysctl.
