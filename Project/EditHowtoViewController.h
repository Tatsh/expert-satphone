...
/**
 * A view controller presenting the "how to" help pages for edit mode.
 */
...
/**
 * Sets the preferred content size to the pad help area.
...
/**
 * Builds the paging scroll view, its two help images, and the page indicator.
