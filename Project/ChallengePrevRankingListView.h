...
/**
 * Told when the line-up list is closed or a row is selected.
 */
...
/**
 * A dimmed-overlay modal listing the previous-ranking line-up tunes over a background plate
...
/**
 * Builds the list view over the given line-up records, initially hidden.
