...
/**
 * Odds and ends the store screens share.
 */
@interface StoreUtil : NSObject

/**
 * The store tab header height, 44 points.
 * @return Always 44.
 * @ghidraAddress 0xb9844
 */
+ (int)storeTabHeaderHeight;
/**
 * The store tab footer height, 49 points.
 * @return Always 49.
 * @ghidraAddress 0xb984c
 */
+ (int)storeTabFooterHeight;
/**
 * The store category list height, 80 points.
 * @return Always 80.
 * @ghidraAddress 0xb9854
 */
+ (int)storeCategoryListHeight;
/**
 * The store category title height, 100 points.
 * @return Always 100.
...
/**
 * Builds a @c "&key=value" query fragment from a dictionary's string entries.
 *
...
/**
 * The store's new-information URL, carrying the client info as a query.
...
/**
 * The pack-list URL for a page, optionally filtered by genre.
 *
...
/**
 * The recommended-pack-list URL: head 0, limit 8, and a random genre when @p useGenre is
 * set.
 *
...
/**
 * The optional-pack-list URL for a set of pack identifiers.
 *
...
/**
 * The pack-info URL for a pack, carrying the client info as a query.
...
/**
 * The restore-pack-info URL for a pack, carrying the client info as a query.
 * @param packID The pack identifier.
...
/**
 * The music-info URL for a tune, carrying the client info as a query.
...
/**
 * The free-music-list (privilege) URL keyed by a value.
...
/**
 * The privilege music-info URL; forwards to @c +musicInfoURL: .
 * @param musicID The tune identifier.
...
/**
 * The receipt-verify URL for a new purchase; delegates to @c ScratchUtil .
 * @return The receipt-verify URL.
 * @ghidraAddress 0xba464
 */
+ (nullable NSURL *)verifyReceiptNewURL;
/**
 * The receipt-verify URL for a consumable purchase; delegates to @c ScratchUtil . Identical
...
/**
 * The store extend-list URL, carrying the last-update timestamp.
 *
...
/**
 * Verifies a signed store response and returns its JSON body.
 *
...
/**
 * Formats a price number as a currency string in a locale.
 *
...
/**
 * Whether a string is a URL worth keeping.
 *
...
/**
 * Maps a pack identifier to its App Store product identifier.
 *
 * DECLARED ONLY.
 *
...
/**
 * Maps an App Store product identifier back to its pack identifier.
 *
...
/**
 * Whether a tune's file is present, whether built in or downloaded.
 *
...
/**
 * Whether any entry has a downloadable extend tune that is not yet on disk.
 *
...
/**
 * Extracts the App Store affiliate parameters from an iTunes URL.
 *
...
/**
 * Where a downloaded tune's data would live.
 *
...
/**
 * The endpoint the store's knit background colour is fetched from.
 *
