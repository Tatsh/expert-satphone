...
/**
 * Loads one audio file into an OpenAL buffer and plays it on demand.
 *
...
/**
 * Opens an OpenAL stack and loads the file at @c path into it.
 *
...
/**
 * Plays the loaded sound from the start. Non-looping.
 * @ghidraAddress 0x153ed0
 */
- (void)sePlay;

/**
 * Stops playback and tears the whole OpenAL stack down.
 *
