...
/**
 * The rounded highlight the segmented control slides over its selected segment.
 *
...
/**
 * The owning segmented control. Held unretained (a back-pointer to the parent).
...
/**
 * A custom image drawn in place of the default gradient when the thumb is unselected.
 *
...
/**
 * A custom image drawn in place of the default gradient when the thumb is selected.
 * @ghidraAddress 0x170860 (getter), 0x170870 (setter)
 */
@property(nonatomic, strong, nullable) UIImage *highlightedBackgroundImage;

/**
 * The colour multiplied over the default gradient with the overlay blend mode.
 *
...
/**
 * The label text colour. The setter pushes the value onto both labels.
 * @ghidraAddress 0x170894 (getter), 0x16ff28 (setter)
 */
@property(nonatomic, assign, nullable) UIColor *textColor;

/**
 * The label text shadow colour. The setter pushes the value onto both labels' shadowColor.
 * @ghidraAddress 0x1708a4 (getter), 0x16ffcc (setter)
 */
@property(nonatomic, assign, nullable) UIColor *textShadowColor;

/**
 * The label text shadow offset. The setter pushes the value onto both labels' shadowOffset.
 * @ghidraAddress 0x1708b4 (getter), 0x170070 (setter)
 */
@property(nonatomic, assign) CGSize textShadowOffset;

/**
 * Whether the thumb casts a drop shadow. The setter drives the layer's shadow opacity.
 * @ghidraAddress 0x1708c8 (getter), 0x170110 (setter)
 */
@property(nonatomic, assign) BOOL shouldCastShadow;

/**
 * Whether the thumb is in its selected (pressed) look.
 *
...
/**
 * Alias of @c textShadowColor. The setter forwards to @c -setTextShadowColor:.
 * @ghidraAddress 0x1708e8 (getter), 0x170818 (setter)
 */
@property(nonatomic, assign, nullable) UIColor *shadowColor;

/**
 * Alias of @c textShadowOffset. The setter forwards to @c -setTextShadowOffset:.
 * @ghidraAddress 0x1708f8 (getter), 0x17080c (setter)
 */
@property(nonatomic, assign) CGSize shadowOffset;

/**
 * Alias of @c shouldCastShadow. The setter forwards to @c -setShouldCastShadow:.
 * @ghidraAddress 0x17090c (getter), 0x170824 (setter)
 */
@property(nonatomic, assign) BOOL castsShadow;

/**
 * The font of both labels. The getter reads the primary label's font; the setter pushes
...
/**
 * The primary title label, created lazily and added as a subview on first access.
 * @ghidraAddress 0x16f680
 */
@property(nonatomic, strong, readonly) UILabel *label;

/**
 * The secondary (crossfade) title label, created lazily and added as a subview on first
 * access.
...
/**
 * Builds the thumb with its library defaults (clear background, white text on a black
...
/**
 * Restores the thumb to its unselected look, showing the primary label unless the control
...
/**
 * Puts the thumb into its selected look, hiding the primary label unless the control
 * crossfades labels while dragging.
