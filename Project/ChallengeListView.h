...
/**
 * @brief Told when the list is closed or a row is selected.
 */
...
/**
 * @brief A table of list rows over a background plate with a title and a close button. Rows
...
/**
 * @brief Sets the optional detail-text sub-list, run in parallel with the main list.
...
/**
 * @brief Sets the main list rows, clears any pickup, and reloads the table.
...
/**
 * @brief Marks the row at the given index as picked up and scrolls it into a cell.
