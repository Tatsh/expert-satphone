...
/**
 * Told when the previous-ranking view wants its host menu closed.
 *
...
@optional
/** Close the hosting challenge-mode menu. */
- (void)closeMenu;
@end

/**
 * A challenge-mode modal that fetches the previous event's line-up over a signed session
...
/**
 * The delegate told when the menu should close. Held weakly.
...
/**
 * Builds the view and kicks off the previous-scratch line-up download.
 *
