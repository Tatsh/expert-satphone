...
/**
 * Shows one encrypted artwork file, filling a caller-supplied rectangle.
 *
...
/**
 * This page's position within the viewer.
 *
...
/**
 * Records the artwork to show and the rectangle to show it in.
 *
