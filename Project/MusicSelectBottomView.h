/**
 * @file
 * The bottom bar of the music-select screen: an all-songs / playlists button on the left,
...
/**
 * What a @c MusicSelectBottomView tells its owner (the music-select controller).
 *
...
@optional
/**
 * The playlists button was tapped.
 * @param sender The tapped button.
 */
- (void)tapPlaylists:(nullable id)sender;
/**
 * The jubeat Lab. button was tapped.
 * @param sender The tapped button.
 */
- (void)tapJubeatLab:(nullable id)sender;
/**
 * The store-info ticker was tapped.
...
/**
 * A bar control went down (touch-began): the delegate can show a pressed state.
 * @param sender The pressed control.
 */
- (void)btnTouchesBegan:(nullable id)sender;
/**
 * A bar control's touch was cancelled: the delegate can clear a pressed state.
...
/**
 * The music-select screen's bottom bar.
 *
...
/**
 * The playlists button's action: forwards to the delegate.
 * @param sender The tapped button.
...
/**
 * A control's touch-down action: forwards to the delegate so it can show a pressed state.
 * @param sender The pressed control.
...
/**
 * A control's touch-cancel action: forwards to the delegate so it can clear a pressed state.
 * @param sender The released control.
...
/**
 * The playlists button's frame in the bar's own coordinate space.
...
/**
 * Retitles or re-icons the playlists button for the selected playlist.
 *
...
/**
 * The store-info ticker's action: resolves the current message's link and forwards it to
 * the delegate.
 *
...
/**
 * Installs the ticker's message list and starts the cycle.
 *
...
/**
 * Shows the next ticker message: sets the label text, resets the scroll, fades the label in,
...
/**
 * Hides the current ticker message: disables the button, advances the index, and fades the
...
/**
 * Stops the ticker button's title animation by removing all layer animations.
 * @ghidraAddress 0x1d7ba0
 */
- (void)animStop;

/**
 * The jubeat Lab. button's action: forwards to the delegate.
 * @param sender The tapped button.
