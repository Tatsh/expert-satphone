...
/**
 * The knit-theme phone-idiom concrete in-game renderer.
 */
...
/**
 * Initialises the renderer, caching the device flags and building the knit background.
...
/**
 * Loads every play-session texture for the knit theme. The selector spelling @c loadTexure:
 *        is the binary's own.
...
/**
 * Releases the play-session textures the knit renderer owns.
...
/**
 * Sets the high-level render state, loading the result textures and BGM on the result state
...
/**
 * Clears the ready textures and enters the playing state.
...
/**
 * Draws one clipped sprite region: a sprite index at a position within a clip area, at an
 *        opacity.
...
/**
 * Draws the start-mark banner over the first-marker panels.
 * @param alpha The opacity.
...
/**
 * Draws the note markers over the sixteen-panel grid, delegating the hold markers.
 * @ghidraAddress 0x18c74c
 */
- (void)renderMarker;

/**
 * Draws the knit play-field background and its effect sprites.
 * @ghidraAddress 0x18caf0
 */
- (void)renderBG;

/**
 * Draws the beat shutter over the play field.
...
/**
 * Draws the score digits tweening up towards a target.
...
/**
 * Draws the player score at a point.
...
/**
 * Draws the partner score at a point, with a horizontal scale and alpha.
...
/**
 * Draws the difficulty music bar and its optional timeline cursor.
...
/**
 * Draws the knit upper background band.
...
/**
 * Draws the full-combo celebration banner and word.
...
/**
 * Draws the excellent celebration animation for a frame.
...
/**
 * Draws the result-screen rating chips for a frame.
 * @param animFrame The animation frame.
...
/**
 * Draws the cleared-screen animation for a frame.
 * @param animFrame The animation frame.
 * @return Whether the animation is still running.
...
/**
 * Draws the failed-screen animation for a frame.
 * @param animFrame The animation frame.
 * @return Whether the animation is still running.
...
/**
 * Draws the whole play frame, dispatching on the state and flushing every texture atlas.
 * @ghidraAddress 0x193214
 */
- (void)draw;

/**
 * Draws a run of debug text from the debug-font atlas.
...
/**
 * The vertical offset of the button area, in points. Always zero for the knit phone.
...
/**
 * The button identifier for the end action. Returns 15 for the knit phone.
 * @ghidraAddress 0x1922f0
 */
@property(nonatomic, readonly) unsigned int endButtonID;

/**
 * The button identifier for the evaluate action. Returns 14 for the knit phone.
 * @ghidraAddress 0x1922f8
 */
@property(nonatomic, readonly) unsigned int evaluateButtonID;

/**
 * The button identifier for the good-job action. Returns 13 for the knit phone.
...
/**
 * The button identifier for the tweet-send action. Returns 14 for the knit phone.
...
/**
 * The button identifier for the store-move action. Returns 14 for the knit phone.
