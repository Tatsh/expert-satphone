/**
 * @file
 * The settings-screen policy/terms view controller.
 *
...
/**
 * The legal document a @c SettingsPolicyViewController downloads and displays. The value is
...
/**
 * A view controller presenting a downloaded policy/terms document in the settings screen.
 */
@interface SettingsPolicyViewController : UIViewController <DownloaderDelegate>

/**
 * Sets the navigation title for the given policy type and, on iOS 7 and later, opts the
...
/**
 * Builds the view: a white background and a non-editable @c UITextView, then kicks off the
...
/**
 * Loads the downloaded document text into the text view, or a localised network-error
...
/**
 * Shows a localised network-error message in the text view.
