...
/**
 * What a @c StorePackView tells its owner.
 */
...
/**
 * A tappable tile showing one pack's artwork, name, comment, price, and status markers.
 */
...
/**
 * The tile's position in the pack list, as last given to @c -loadPackInfo:index: .
...
/**
 * Sets the tile's background image.
...
/**
 * The tap handler: tells the delegate the tile was selected.
...
/**
 * Fills the tile's labels and markers from a pack's info.
