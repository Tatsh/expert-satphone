...
/**
 * Told when a purchase row is chosen.
 */
...
/**
 * A table of cube-purchase packs, each row a `CubePurchaseListViewCell` drawn over a shared
...
/**
 * Sets the pack rows and reloads the table.
