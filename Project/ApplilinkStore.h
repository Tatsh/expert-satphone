...
/**
 * The delegate the SDK's advert, App Store, and web views all report back through. The
...
/**
 * The App Store product page transitioned.
 * @param appParam The advert parameters the page was opened for.
 */
...
/** The caller's delegate, told when the store opens/closes. Held weakly.
 *  @ghidraAddress 0x250c88 (getter), 0x250ca8 (setter) */
@property(weak, nonatomic, nullable) id<SdkViewDelegate> sdkDelegate;
/** The advert request parameters for the presented store.
...
/**
 * Presents the App Store product page for a product identifier.
...
/**
 * Dismisses the presented App Store product page.
