...
/**
 * What a @c JcfManageNavController tells its owner. The delegate is messaged dynamically
 * behind @c -respondsToSelector: ; this protocol only documents the selector.
 */
@protocol JcfManageNavControllerDelegate <NSObject>
@optional
/**
 * The user closed the custom-sequence management list.
...
/**
 * Hosts the downloaded custom-sequence management list in a navigation controller.
 */
@interface JcfManageNavController : RotatableNavigationController

/**
 * The object told when the management list is closed.
 *
...
/**
 * The wrapped list of downloaded custom-sequence files.
 */
@property(nonatomic, strong, nullable) EditFileListViewDeleteController *pFileListView;

/**
 * The designated initialiser: builds the wrapped file list, the navigation bar chrome, and
...
/**
 * Forwards the share flag to the wrapped file list.
...
/**
 * Forwards the tune id to the wrapped file list.
...
/**
 * Reloads the wrapped file list with a new set of files.
 * @param fileList The downloaded custom-sequence files to list.
...
/**
 * Left "Close" button action: notifies the delegate that the list was closed.
