/**
 * @file
 * The navigation controller that wraps the jubeatLab custom-sequence (jcf) download web
 * page.
 *
...
/**
 * What a @c JcfDownloadPageNavController tells its owner. The delegate is messaged
...
/**
 * Hosts the jubeatLab custom-sequence download web page in a navigation controller.
 */
@interface JcfDownloadPageNavController : UINavigationController

/**
 * Builds the local test-page request URL used by the download web view.
...
/**
 * Configures the navigation bar chrome (style, tint, and background colours).
 * @ghidraAddress 0x1e59d8
 */
- (void)initNavigationBar;

/**
 * Opens the download page for a music id.
...
/**
 * Opens the download page for a sequence id.
...
/**
 * Opens the download page for a prebuilt URL.
...
/**
 * Left "Close" button action: persists defaults and notifies the delegate.
