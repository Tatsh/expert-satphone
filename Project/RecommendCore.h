...
/**
 * The pending App Store deep-link URL string, held between a redirect and its launch.
 */
...
/**
 * The delegate that receives interstitial advert-screen lifecycle callbacks.
 */
...
/**
 * Reset the initialisation flag and clear the cached advert data, expiry, and cache folder.
...
/**
 * Open a full-screen movie advert view controller.
 * @param adModel The advert-model identifier.
 * @param adLocation The ad-location identifier.
 * @param verticalAlign The vertical-alignment identifier.
 * @param requestCode The caller's request code.
...
/**
 * Present a video advert view for @p query inside the current advert-screen view.
...
/**
 * Show a first-party advert with the default advert model.
 * @param adLocation The ad-location identifier.
...
/**
 * Show a first-party advert for @p adModel.
 * @param adLocation The ad-location identifier.
 * @param adModel The advert-model identifier.
 * @param appliId The advert application identifier.
 * @param creativeId The advert creative identifier.
...
/**
 * Register a first-party advert touch with the default advert model.
 * @param adLocation The ad-location identifier.
 * @param appliId The advert application identifier.
 * @param creativeId The advert creative identifier.
 * @param requestCode The caller's request code.
...
/**
 * Register a first-party advert touch for @p adModel.
 * @param adLocation The ad-location identifier.
 * @param adModel The advert-model identifier.
 * @param appliId The advert application identifier.
 * @param creativeId The advert creative identifier.
...
/**
 * Launch the click link action for a movie advert against a fully formed URL.
...
/**
 * Notify the delegate that the advert list started using sound.
 * @ghidraAddress 0x270dc0
 */
- (void)appListSoundUseStart;

/**
 * Notify the delegate that the advert list finished using sound.
...
/**
 * Report an App Store advert load failure, launching a pending deep link if one is held.
 * @param error The load error.
 * @param appParam The advert parameters.
...
/**
 * Build the movie-end reporting URL from its request parameters.
