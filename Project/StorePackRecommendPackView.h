...
/**
 * A recommended-pack tile: jacket, name, and the (here unused) sample and link controls.
 */
@interface StorePackRecommendPackView : UIView

/** The pack jacket, which loads itself from a URL. @ghidraAddress 0x89288 (getter) */
@property(nonatomic, strong, nullable) StoreImageView *artworkView;
/** The pack name label. @ghidraAddress 0x892ac (getter) */
@property(nonatomic, strong, nullable) UILabel *labelName;
/** The artist label (cleared by @c -setInfo:). @ghidraAddress 0x892d0 (getter) */
@property(nonatomic, strong, nullable) UILabel *labelArtist;
/** The difficulty-levels label (cleared by @c -setInfo:). @ghidraAddress 0x892f4 (getter) */
@property(nonatomic, strong, nullable) UILabel *labelLevels;
/** The sample-play button. @ghidraAddress 0x89318 (getter) */
@property(nonatomic, strong, nullable) UIButton *buttonSample;
/** The iTunes link button. @ghidraAddress 0x8933c (getter) */
@property(nonatomic, strong, nullable) UIButton *buttonLink;
/** The extension marker. @ghidraAddress 0x89360 (getter) */
@property(nonatomic, strong, nullable) UIImageView *extendImg;
/** The sample-download spinner over the sample button. @ghidraAddress 0x89384 (getter) */
@property(nonatomic, strong, nullable) UIActivityIndicatorView *indicatorSample;

/**
 * Builds the tile's subviews.
...
/**
 * Fills the tile from a pack's info, or clears it when nil.
