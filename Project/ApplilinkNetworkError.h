...
/**
 * The domain of every @c NSError this class produces.
 * @ghidraAddress 0x2e4a80
 */
extern NSErrorDomain const ApplilinkErrorDomain;

/**
 * Builds applilink errors carrying a localised description.
 */
@interface ApplilinkNetworkError : NSObject

/**
 * Builds a localised error with no caller-supplied user info.
 *
...
/**
 * Builds a localised error, merging caller-supplied user-info entries.
 *
