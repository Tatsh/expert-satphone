...
/**
 * Builds and holds an HTTP request to the jubeatLab API and reports its outcome to a
 * delegate.
 */
@interface jubeatLabAccess : NSObject <NSURLSessionDataDelegate>

/**
 * Starts the request on the main queue.
 *
...
/**
 * Abandons the request: clears the weak delegate, cancels the task, and drops the data.
...
/**
 * The response body decoded as a JSON dictionary, or nil when it is absent or not a
 * dictionary.
...
/**
 * The download progress in [0, 1], or 0 when the expected length is unknown.
...
/**
 * Builds a plain GET request to a URL.
 *
...
/**
 * Builds a request to a URL with a body and an explicit HTTP method.
 *
...
/**
 * Builds the keychain lookup query for an account. Identical to
...
/**
 * Reads the keychain payload for an account and decodes it as a UTF-8 string. Identical to
...
/**
 * Starts a create-user-identifier request, POSTing the device UUID.
...
/**
 * Starts a session-open request, POSTing the passphrase for the current editor identifier.
 * @param delegate The object told how the request finished.
 * @return The initialised client.
...
/**
 * Starts a top-page session-open request (the @c Session2 variant).
 * @param delegate The object told how the request finished.
 * @return The initialised client.
...
/**
 * Starts a GET for the privacy-policy last-update timestamp.
 * @param delegate The object told how the request finished.
 * @return The initialised client.
...
/**
 * Starts a GET for the privacy policy.
 * @param delegate The object told how the request finished.
 * @return The initialised client.
...
/**
 * Starts a GET for the lab top-page URL.
 * @param delegate The object told how the request finished.
 * @return The initialised client.
...
/**
 * Starts an upload of a custom sequence.
 *
...
/**
 * Starts a GET of a shared sequence by its identifier.
 *
...
/**
 * Starts a GET of the recommended pack for a tune.
 * @param delegate The object told how the request finished.
...
/**
 * Starts a good-job (like) POST for a sequence.
 *
...
/**
 * Starts a vote-level POST for a sequence.
 *
...
/**
 * Starts a play-count POST for a sequence.
 *
...
/**
 * Starts a special-user creation POST.
 *
...
/**
 * Builds a web-page URL under the lab host.
 *
...
/**
 * The user-management web page URL.
...
/**
 * The session-error web page URL.
...
/**
 * The sequence-search web page URL for a music identifier.
...
/**
 * The sequence-detail web page URL for a sequence identifier.
