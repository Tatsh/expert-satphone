...
/**
 * @brief A vertical gradient between two colours, drawn top to bottom.
 *
...
/**
 * @brief The colour at the top edge. Defaults to clear.
 *
...
/**
 * @brief The colour at the bottom edge. Defaults to clear. Same copy caveat as @c topColor.
 */
