...
/**
 * What an @c AppliView tells its owner.
 */
@protocol AppliViewDelegate <NSObject>
@optional
/**
 * Sent when the view is tapped.
 *
...
/**
 * A full-bleed advert surface that reports each tap.
 */
@interface AppliView : UIView

/**
 * The object told when the view is tapped.
 *
...
/**
 * Builds the surface: interaction enabled, fully flexible autoresizing, aspect-fit content.
