...
/**
 * Builds the paging scroll view, its five help images, and the page indicator.
 * @ghidraAddress 0xe8798
 */
- (void)loadView;

/**
 * Updates the page indicator to the page nearest the scroll view's content offset.
