/**
 * @file
 * The list of recently seen JCF owners.
 *
...
/**
 * Keeps at most twenty recently seen owners, each with the time it was recorded.
 */
...
/**
 * Records an owner, evicting an existing entry once the list is full.
 *
...
/**
 * Removes every entry naming an owner.
 * @param owner The owner's name.
