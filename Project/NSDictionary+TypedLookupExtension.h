/**
 * @file
 * TouchJSON's @c NSDictionary @c TypedLookupExtension category.
 *
...
/**
 * Class-checked value lookup over @c NSDictionary.
 */
@interface NSDictionary (TypedLookupExtension)

/**
 * The value for @p key when it is a kind of @p aClass, otherwise @c nil.
...
/**
 * The value for @p key coerced to an @c NSDictionary.
 * @param key The dictionary key.
...
/**
 * The value for @p key coerced to an @c NSArray.
 * @param key The dictionary key.
...
/**
 * The value for @p key coerced to an @c NSNumber.
 * @param key The dictionary key.
...
/**
 * The value for @p key coerced to an @c NSString.
 * @param key The dictionary key.
