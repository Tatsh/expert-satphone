...
/**
 * A challenge mission's identity, description, and completion condition.
 */
@interface ChallengeMissionTerms : NSObject

/** The mission's identifier. Wire key @c "id". */
@property(nonatomic, readonly) int missionID;
/** The mission's display name. Wire key @c "name". */
@property(nonatomic, readonly, nullable) NSString *missionTitle;
/** The mission's description. Wire key @c "description". */
@property(nonatomic, readonly, nullable) NSString *missionExplain;
/**
 * What kind of condition completes the mission. Wire key @c "condition".
 *
...
/** The condition's parameters. Wire key @c "data". */
@property(nonatomic, readonly, nullable) NSArray *missionDetail;
/** What skipping the mission costs. Wire key @c "fee_skip". */
