...
- (instancetype)initWithFrame:(CGRect)frame mInfo:(ScratchInfo *)mInfo rankType:(int)rankType {
...
- (instancetype)initWithFrame:(CGRect)frame mDict:(NSDictionary *)mDict scratchID:(int)scratchID {
    self = [super initWithFrame:frame];
    if (!self) {
        return self;
    }
