...
/**
 * The advert-video host controller.
 *
...
/**
 * The SDK delegate told about ready and close events.
 *
...
/**
 * The advert request parameters. Copied on assignment.
 * @ghidraAddress 0x22681c (getter)
 */
@property(copy, nonatomic, nullable) ApplilinkParameters *applilinkParams;

/**
 * An unused secondary base view. Retained by the property but never assigned.
 * @ghidraAddress 0x226848 (getter)
 */
@property(strong, nonatomic, nullable) UIView *videoBaseView;

/** The movie URL parsed from the query. @ghidraAddress 0x226890 (getter) */
@property(strong, nonatomic, nullable) NSString *movieUrl;
/** The poster-image URL parsed from the query. @ghidraAddress 0x2268d8 (getter) */
@property(strong, nonatomic, nullable) NSString *posterUrlRect;
/** The store URL parsed from the query. @ghidraAddress 0x226920 (getter) */
@property(strong, nonatomic, nullable) NSString *storeUrl;
/** The store identifier parsed from the query. @ghidraAddress 0x226968 (getter) */
@property(strong, nonatomic, nullable) NSString *storeId;
/** The movie-end URL. @ghidraAddress 0x2269b0 (getter) */
@property(strong, nonatomic, nullable) NSString *endUrl;
/** The sound flag parsed from the query. @ghidraAddress 0x2269f8 (getter) */
@property(strong, nonatomic, nullable) NSString *movieVoiceFlg;
/** The advert type parsed from the query. @ghidraAddress 0x226a40 (getter) */
@property(strong, nonatomic, nullable) NSString *adType;
/** The advert model parsed from the query. @ghidraAddress 0x226a88 (getter) */
@property(strong, nonatomic, nullable) NSString *adModel;
/** The advert location parsed from the query. @ghidraAddress 0x226ad0 (getter) */
@property(strong, nonatomic, nullable) NSString *adLocation;
/** The impression identifier parsed from the query. @ghidraAddress 0x226b18 (getter) */
@property(strong, nonatomic, nullable) NSString *impressionId;
/** The destination application identifier. @ghidraAddress 0x226b60 (getter) */
@property(strong, nonatomic, nullable) NSString *appliIdTo;
/** The source advert identifier. @ghidraAddress 0x226ba8 (getter) */
@property(strong, nonatomic, nullable) NSString *adIdFrom;
/** The destination advert identifier. @ghidraAddress 0x226bf0 (getter) */
@property(strong, nonatomic, nullable) NSString *adIdTo;
/** The creative identifier parsed from the query. @ghidraAddress 0x226c38 (getter) */
@property(strong, nonatomic, nullable) NSString *creativeId;
/** The display-number parameter. @ghidraAddress 0x226c80 (getter) */
@property(strong, nonatomic, nullable) NSString *displayNumber;
/** The incentive-type parameter. @ghidraAddress 0x226cc8 (getter) */
@property(strong, nonatomic, nullable) NSString *incentiveType;
/** The install flag parsed from the query. @ghidraAddress 0x226d10 (getter) */
@property(strong, nonatomic, nullable) NSString *installFlg;

/**
 * The caller's request code, untyped in the metadata.
 * @ghidraAddress 0x226d58 (getter)
 */
@property(strong, nonatomic, nullable) id requestCode;

/**
 * Set once the end-card web view has finished loading and is ready to be shown.
 * @ghidraAddress 0x226d78 (getter)
 */
@property(nonatomic) BOOL movieEndViewReadyFlg;

/**
 * Set when the controller's view is hosted directly in the parent window rather than a
...
/**
 * Sets @c parentWindowFlag . A hand-written setter distinct from the synthesised one.
...
/**
 * Parses the advert query and builds the player.
 *
...
/**
 * Called when the whole player finishes; forwards @c -closeNotice: to the SDK delegate.
 * @ghidraAddress 0x225678
 */
- (void)toucheEnded;

/**
 * Called when the app-list web view appears; opens the store URL then closes the player.
 * @ghidraAddress 0x225d08
 */
- (void)appListDidAppear;

/**
 * Rebuilds the movie view laid out for the given interface orientation.
...
/**
 * Tears the player and web view down and clears every parsed parameter.
