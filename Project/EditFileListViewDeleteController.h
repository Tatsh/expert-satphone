...
/**
 * What an @c EditFileListViewDeleteController tells its owner.
 *
...
@optional
/** Sent when the "make a chart" menu row is chosen. */
- (void)editFileListViewSelectNewFile;
/** Sent when the "find a chart to download" menu row is chosen. */
- (void)editFileListViewSelectDownload;
/**
 * Sent when a saved chart is deleted.
...
/**
 * A table of saved edit charts that supports deleting a chart by swiping a row.
 *
...
/**
 * Initialises the controller at a given size and seeds the slot limit.
...
/**
 * Builds (or dequeues) a menu cell for one of the top-section entries.
...
/**
 * Returns the cell for a row across all three sections.
...
/**
 * Tints a cell's background just before it is shown.
 * @param tableView The table asking.
...
/**
 * Returns the row count for a section.
 * @param tableView The table asking.
...
/**
 * Returns the section count (always three).
 * @param tableView The table asking.
...
/**
 * Deletes a saved chart, updates the counts, and re-lays the table.
 * @param tableView The table asking.
...
/**
 * Only saved-chart rows that exist may be edited (deleted).
 * @param tableView The table asking.
 * @param indexPath The row's index path.
...
/**
 * Returns the footer height for a section.
 * @param tableView The table asking.
 * @param section The section asked about.
...
/**
 * Builds the coloured footer strip for a section once the slots are full.
 * @param tableView The table asking.
 * @param section The section asked about.
...
/**
 * Handles taps: opens the menu actions or reports the chosen chart.
...
/**
 * Records the file name of the chart to highlight in the list.
...
/**
 * Adopts a new chart list and recomputes the used and blank slot counts.
...
/**
 * Reloads the backing table view.
 * @ghidraAddress 0x1fab04
 */
- (void)reloadTable;

/**
 * Whether this is the first appearance (suppresses the new-chart highlight).
 * @ghidraAddress 0x1fab44
 */
@property(nonatomic) BOOL isFirst;

/**
 * Whether the list is a shared (read-only) list.
 * @ghidraAddress 0x1fab64
 */
@property(nonatomic) BOOL isShared;

/**
 * The music id the download action opens.
 * @ghidraAddress 0x1fab84
 */
@property(nonatomic) int tuneID;

/**
 * The owning edit controller.
