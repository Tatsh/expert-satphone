...
/**
 * @brief What a @c ChallengeMenuView tells its owner (the challenge menu's root view).
 *
...
/**
 * @brief The challenge-mode landing menu.
 *
...
/**
 * @brief Builds the menu: background plate, close button, digit-artwork cache, and the table.
...
/**
 * @brief The close button's action: tells the delegate to close the root menu.
...
/**
 * @brief Alert-button callback: begins the purchase restore when the link-purchases alert is
 * confirmed.
...
/**
 * @brief Presents the modal progress dialog, faded in, and disables interaction beneath it.
...
/**
 * @brief Removes the progress dialog and re-enables interaction.
 * @ghidraAddress 0x4352c
 */
- (void)hideVerifyDialog;

/**
 * @brief Restore failed: drops the purchase delegate and hides the dialog.
...
/**
 * @brief Restore finished with nothing to restore: hides the dialog and shows the completion alert.
 * @ghidraAddress 0x435d8
 */
- (void)restoreNothing;

/**
 * @brief Restore succeeded: hides the dialog and shows the completion alert.
 *
...
/**
 * @brief Purchase succeeded: shows a follow-up link-purchases confirmation alert.
...
/**
 * @brief Purchase failed: shows a network-error alert for a code-1 failure, then hides the dialog.
...
/**
 * @brief Refreshes the present badge on the first row. Forwards to @c -setPresentMark.
 * @ghidraAddress 0x43cb0
 */
- (void)refreshView;

/**
 * @brief Draws a count on the present badge's per-digit image views, or clears them.
...
/**
 * @brief Reads the unread-present count and pushes it onto the first row's cell.
