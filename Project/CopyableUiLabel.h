...
/**
 * A label that becomes first responder when tapped and offers a Copy menu.
 *
...
/**
 * Makes the label transparent and, crucially, touchable.
 *
...
/**
 * Takes first responder status and shows the edit menu over the label.
...
/**
 * Always YES, so the edit menu can appear.
 * @return YES.
...
/**
 * Allows @c copy: and defers every other action to the superclass.
...
/**
 * Puts the label's text on the general pasteboard.
