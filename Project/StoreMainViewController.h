...
/**
 * Scrolls the pack table back to the top, and dismisses the one-time tutorial balloon on its
...
/**
 * Pack-table scroll callback: fades the tutorial balloon back in.
...
/**
 * Forwards a recommended-pack open request to the parent store view, discarding the current
...
/**
 * Policy-button handler: presents the terms navigation controller.
...
/**
 * Pack-detail extend-download callback: forwards to the parent store view.
...
/**
 * The settings navigation controller closed: dismisses it.
...
/**
 * The StoreKit product page finished: dismisses it.
...
/**
 * Releases the view's subviews when the view is unloaded.
