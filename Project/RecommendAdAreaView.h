...
/**
 * The SDK delegate notified of the raw open, close, and failure notices. Held weakly.
...
/**
 * Copy an impression identifier into the view.
...
/**
 * Notify the delegates that the advert list appeared.
...
/**
 * Handle an advert-tap request, routing App Store transitions, first-party clicks, movie
...
/**
 * Handle the advert opening. This is an empty hook.
...
/**
 * Handle an advert open error. This is an empty hook.
 * @ghidraAddress 0x27493c
 */
- (void)openErrorNotice;

/**
 * Handle the App Store product page opening. This is an empty hook.
...
/**
 * Handle the App Store product page having closed. This is an empty hook.
 * @ghidraAddress 0x27496c
 */
- (void)appStoreClosedNotice;

/**
 * Handle an App Store product-page load failure. This is an empty hook.
 * @param error The load failure error.
...
/**
 * Handle the App Store product page transitioning. This is an empty hook.
