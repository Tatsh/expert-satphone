...
/**
 * The wire keys of a mission achievement record.
 */
...
/** The alternative mission identifier, read only when the first is zero. */
...
/**
 * Loads every field from a server record.
 *
...
/**
 * Merges a later server record into this one.
 *
