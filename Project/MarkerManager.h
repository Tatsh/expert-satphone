...
/**
 * @brief Owns the marker assets and their on-disc layout.
 */
@interface MarkerManager : NSObject

/**
 * @brief Initialises the manager with a delegate.
 *
...
/**
 * @brief The reserved marker index boundary.
 *
...
/**
 * @brief The number of markers in the default list.
 *
...
/**
 * @brief The position of a marker within the current (installed) list.
 *
...
/**
 * @brief The full persisted marker list, deciphered and unarchived.
 *
...
/**
 * @brief Archives, enciphers, and persists @p list.
 *
...
/**
 * @brief The installed markers, excluding those whose version is still @c 0.0.0.
 *
...
/**
 * @brief The marker at @p index within the current (installed) list.
 *
...
/**
 * @brief Inserts or replaces a marker in the list, keeping it ordered by identifier.
 *
...
/**
 * @brief Whether a marker's banner data is present.
 *
...
/**
 * @brief Whether a marker's data is present on disc and passes its MD5 trailer check.
 *
 * @param name The marker's data name.
...
/**
 * @brief Excludes a file URL from iCloud backup.
 *
...
/**
 * @brief Extracts a banner image from a downloaded marker archive, or copies the bundled banner.
 *
...
/**
 * @brief Writes downloaded marker data to its installed path and excludes it from backup.
 *
...
/**
 * @brief Copies a bundled marker or banner resource into the installed marker directory.
 *
...
/**
 * @brief Copies a bundled marker ZIP into the installed marker directory.
 *
...
/**
 * @brief Copies a bundled banner PNG into the installed banner directory.
 *
...
/**
 * @brief Copies both a bundled marker and its banner into place.
 *
...
/**
 * @brief The installed marker directory, creating it (and the private documents parent) as needed.
 *
...
/**
 * @brief Builds and persists the built-in default marker list.
 *
...
/**
 * @brief Migrates a legacy marker-version list into the current list format.
 *
...
/**
 * @brief Validates the installed marker list, rebuilding it from defaults when it is missing.
 *
...
/**
 * @brief Whether marker selection may be enabled.
 *
...
/**
 * @brief Copies the built-in current marker into the Documents marker directory.
 *
 * @return Always YES.
