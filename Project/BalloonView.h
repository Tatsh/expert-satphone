...
/**
 * @brief Which edge of the balloon carries the arrow.
 *
...
/**
 * @brief A speech balloon: a rounded rectangle with one triangular arrow.
 */
@interface BalloonView : UIView

/**
 * @brief The edge the arrow sits on.
 *
 * Defaults to @c BalloonViewArrowDirectionUp.
 */
@property(nonatomic) BalloonViewArrowDirection arrowDirection;
/**
 * @brief How far along its edge the arrow's centre sits, in points from the leading edge.
 *
...
/**
 * @brief The arrow's base width and its height measured outwards from the edge.
 *
 * Defaults to 20 x 12.
 */
@property(nonatomic) CGSize arrowSize;
/** @brief The balloon's fill. Defaults to black at 0.6 alpha. */
@property(nonatomic, strong) UIColor *balloonColor;
/** @brief The outline's colour. Defaults to white. */
@property(nonatomic, strong) UIColor *borderColor;
/** @brief The corner radius. Defaults to 8. */
@property(nonatomic) CGFloat borderRadius;
/**
 * @brief The outline's width. Defaults to 2.
 *
...
/** @brief Padding between the balloon's inner edge and @c contentRect. Defaults to zero. */
@property(nonatomic) UIEdgeInsets contentEdgeInsets;

/**
 * @brief The rectangle a caller may lay content out in.
 *
