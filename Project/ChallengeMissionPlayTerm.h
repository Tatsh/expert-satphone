/**
 * @file
 * The play restrictions a challenge mission imposes, derived from its terms and current
 * progress.
 *
...
/**
 * The lists a mission's play terms resolve to.
 *
...
/** Music identifiers the mission excludes. */
@property(nonatomic, readonly, nullable) NSArray *musicNGID;
/** Markers the mission excludes. */
@property(nonatomic, readonly, nullable) NSArray *markerNG;
/** Levels the mission excludes. */
@property(nonatomic, readonly, nullable) NSArray *levelNG;
/** The plays already recorded against the mission. */
@property(nonatomic, readonly, nullable) NSArray *playHistory;
/**
 * Per-column flags saying which of the compared terms still agree across every play.
 *
...
/** The mission rows still outstanding, once the achieved ones are removed. */
@property(nonatomic, readonly, nullable) NSArray *requireMusicInfo;

/**
 * Returns an empty term with @c -reset already applied.
...
/**
 * Resolves a mission's terms against its progress.
 *
