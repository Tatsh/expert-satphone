...
/**
 * Told when the name-setting sheet wants to close itself.
 */
...
/**
 * A modal sheet letting the player edit and register their challenge-mode name, showing the
 * current search ID beneath a name-entry field.
 */
@interface ChallengeNameSettingView : UIView

/**
 * The delegate told when the sheet should close. Held weakly.
...
/**
 * Builds the sheet, choosing whether it shows a back/close button.
