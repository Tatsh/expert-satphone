{
  ...
  project_name: 'expert-satphone',
  version: '3.9.11',
  security_policy_supported_versions: { '3.9.x': ':white_check_mark:' },
  description: 'Expert satellite phone.',
  keywords: ['decompilation', 'game', 'ios', 'jubeat', 'reverse engineering'],
  want_codeql: false,
  want_tests: false,
  project_type: 'other',
  shared_ignore+: [
