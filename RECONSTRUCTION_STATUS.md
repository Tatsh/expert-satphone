...
which of the four subcommands actually cover anything here. Last run: **497 annotated, 0
...
**As of the last run: 476 of 5036 methods, 9.5%. 103 of 317 classes complete.**
...
| `Project/StoreMusicListManager.m`               | Five of seventeen. Shared manager, init with builtin table, and catalogue queries — verified against the disassembly. |
