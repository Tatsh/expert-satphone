...
which of the four subcommands actually cover anything here. Last run: **502 annotated, 0
...
**As of the last run: 481 of 5036 methods, 9.6%. 103 of 317 classes complete.**
...
| `Project/StoreMusicListManager.m`               | Ten of seventeen. Plus purchased/extend/original dictionaries and the combined ID list — verified against the disassembly. |
