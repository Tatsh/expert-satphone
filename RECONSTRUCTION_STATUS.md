...
which of the four subcommands actually cover anything here. Last run: **563 annotated, 0
...
| `Project/RootViewController.m`                  | Thirty-one methods: both fade dispatchers, both store callbacks, the theme factory, the three application-state handlers, the four view-lifecycle forwarders, the four rotation/status-bar overrides, the logo/title/game fade forwarders, and the achievement-message overlay. |
