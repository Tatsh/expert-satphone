...
which of the four subcommands actually cover anything here. Last run: **96 annotated, 0
...
**As of the last run: 91 of 5012 methods, 1.8%. 18 of 317 classes complete.**
...
ends the method with an `NSLog` on failure, and this one does not.
