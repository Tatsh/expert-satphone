...
| `Project/RootViewController.m`                  | Twenty-four methods: both fade dispatchers, both store callbacks, the theme factory, the three application-state handlers, the four view-lifecycle forwarders, and the four rotation/status-bar overrides. |
