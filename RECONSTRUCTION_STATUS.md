...
which of the four subcommands actually cover anything here. Last run: **525 annotated, 0
...
**As of the last run: 504 of 5036 methods, 10.0%. 104 of 317 classes complete.**
...
| `Project/PurchaseManager.m`                     | Sixteen of thirty-five. Plus consumable purchase and the pending-state queries, StoreKit observers — verified against the disassembly.                                             |
