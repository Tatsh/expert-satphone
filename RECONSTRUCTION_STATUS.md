...
which of the four subcommands actually cover anything here. Last run: **530 annotated, 0
...
**As of the last run: 509 of 5036 methods, 10.1%. 104 of 317 classes complete.**
...
| `Project/PurchaseManager.m`                     | Twenty-one of thirty-five. Plus addProduct and the receipt-verify scaffolding — verified against the disassembly.                                                                  |
