...
which of the four subcommands actually cover anything here. Last run: **452 annotated, 0
...
**As of the last run: 431 of 5036 methods, 8.6%. 101 of 317 classes complete.**
...
| `Project/TitleViewControllerOrg.m`              | Nine of twenty-four. Init/dealloc, viewDidUnload, markerCheckEnd, nextScene, createPolicyView, and the three rotation overrides — all verified against the disassembly. |
...
| ------------------------------------------------------------------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `TitleViewControllerOrg`                            | class at 0x348a78            | Nine of twenty-four written. What is left is the view construction (0x13ac88, 1840 B), animation control (0x13b65c, 0x13b7a8 etc), and input handling (0x13be70, 0x13c328) — all to be verified against the disassembly, not just the decompile. |
