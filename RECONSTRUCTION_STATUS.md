...
which of the four subcommands actually cover anything here. Last run: **535 annotated, 0
...
**As of the last run: 514 of 5036 methods, 10.2%. 104 of 317 classes complete.**
...
| `Project/PurchaseManager.m`                     | Twenty-six of thirty-five. Plus the StoreKit/downloader delegates — verified against the disassembly.                                                                              |
