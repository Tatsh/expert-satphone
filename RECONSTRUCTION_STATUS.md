...
which of the four subcommands actually cover anything here. Last run: **578 annotated, 0
...
| `Project/RootViewController.m`                  | Thirty-nine methods, including -init (builds the two persistent child screens and the achievement overlay) and -loadView. Still outstanding: the four 3-D store/game transitions -openStore:, -endStore, -startMainGame:… and -startEditNote:…. |
