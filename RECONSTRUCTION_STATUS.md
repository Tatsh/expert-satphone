...
which of the four subcommands actually cover anything here. Last run: **580 annotated, 0
...
| `Project/RootViewController.m`                  | Forty-one methods, including the two 3-D store transitions -openStore: and -endStore (the Y-axis cube-flip between music select and the store). Still outstanding: the two game/edit entry points -startMainGame:… and -startEditNote:…. |
