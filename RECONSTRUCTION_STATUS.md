...
which of the four subcommands actually cover anything here. Last run: **520 annotated, 0
...
**As of the last run: 499 of 5036 methods, 9.9%. 104 of 317 classes complete.**
...
| `Project/PurchaseManager.m`                     | Eleven of thirty-five. Plus pack-ID collectors and the encrypted prodlist/pendlist persistence — verified against the disassembly. |
