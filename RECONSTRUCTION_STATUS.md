...
which of the four subcommands actually cover anything here. Last run: **476 annotated, 0
...
**As of the last run: 455 of 5036 methods, 9.0%. 102 of 317 classes complete.**
...
| `Project/TitleViewControllerRpl.m`              | Eight of twenty-four. Init with isPad, viewDidUnload, dealloc, markerCheckEnd, nextScene, createPolicyView, and the three rotation overrides — all verified against the disassembly. |
