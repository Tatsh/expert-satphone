...
| `-[MissionAchievementMessage messageHeight:]`, `-setAchieveTitle:`, `-createAchiveText:`, `+createTitleArray:achieve:`                                | the class's own attributed-text layout; the rest of the class is reconstructed | 0x4e6fc, 0x4fa3c, 0x4fcf0, 0x4d790          |
