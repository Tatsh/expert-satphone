...
| `+[ApplilinkWebAPI requestSynchronousWithURL:method:parameters:cachePolicy:error:]`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | `-[RecommendAdId …]` drives the pasteboard web API through it                                        | not located yet              |
| `ApplilinkCore` network methods and `RewardCore`/`RecommendCore`/`ApplilinkViewManager sharedInstance/rotate…`                                                                                                                                                                                                                                                                                                                                                                                                                                                                | `+[ApplilinkNetwork …]` forwards every facade to them                                                | not located yet              |
| `RewardCore` (`sharedInstance`, `initializeFlg`, `openAdScreen…`, `closeAdScreen`, `allInstallFlgWithCallback:`, `getAdDisplayStatusWithCallback:`, `getAppListStatusWithBlock:`, `setNavigationBarHidden:`) and `ApplilinkCore (+isInitializeStatusFlg)`                                                                                                                                                                                                                                                                                                                     | `+[RewardNetwork …]` forwards every facade to them                                                   | not located yet              |
| `ApplilinkParameters (-setRequestWithAdModel:adLocation:requestCode:)`, `+[ApplilinkCore toDelegateFailOpenWithError:appParam:delegate:]`, `+[ApplilinkNetworkError localizedApplilinkErrorWithCode:]`, and `RecommendCore (-startSessionWithCallback:)`                                                                                                                                                                                                                                                                                                                      | `+[ApplilinkConsts …]` gates requests and starts sessions through them                               | not located yet              |
| `ApplilinkCore` UDID accessors (`ad_udid`, `udid`, `old_udid`, `pasteBoard_udid`, `setAdUdid:`, `clearInitialize`)                                                                                                                                                                                                                                                                                                                                                                                                                                                            | `+[ApplilinkUdid setUdidParameters…]`/`createAdvertisingRewardUdid…` read and update them            | not located yet              |
| `ApplilinkCore` cache/clear methods (`udid_cache`, `ad_udid_cache`, `old_udid_cache`, `clearUDID`, `clearKeyChainOldUDID`, `clearAdUDID`), `AnalysisNetworkCore`, `RewardCore`/`RecommendCore (clearSession/clearAdStatus)`, `RecommendAdCache`, `RecommendDebug`                                                                                                                                                                                                                                                                                                             | `+[ApplilinkDebug …]` forwards every debug action to them                                            | not located yet              |
| `ApplilinkViewController` (`showSKStore:appParam:delegate:`, `productViewControllerDidFinish`, `setSdkDelegate:`)                                                                                                                                                                                                                                                                                                                                                                                                                                                             | `-[ApplilinkStore …]` presents and dismisses the store product page through it                       | not located yet              |
| `+[ApplilinkWebAPI requestAsynchronousWithURL:…finishedBlock:failedBlock:]`, `+[ApplilinkUtilities userAgentParameters]`, and `ApplilinkCore (currentUdid/signatureKey/updatePasteBoard)`                                                                                                                                                                                                                                                                                                                                                                                     | `+[RewardWebAPI …]` posts every reward request through them                                          | not located yet              |
| `RecommendCore` (`sharedInstance`, `initializeFlg`, `getAdStatusWithAdModel:callback:`, `getUnreadCountWithAdModel:adLocation:callback:`, `getAdDisplayStatusWithAdModel:adLocation:callback:`, `showOwnAd…`/`touchOwnAd…` variants, `openAdScreenWithParentView:…`, `openAdAreaWithParentView:rect:…`, `openFullViewControllerWithAdModel:…`, `openMovieViewControllerWithAdModel:…`, `closeAdScreen`), `RecommendWebView`, `RecommendAdAreaView (-closeAdArea)`, and `ApplilinkCore (+mainWindow, +isInitializeStatusFlg, +toDelegateFailOpenWithError:appParam:delegate:)` | `+[RecommendNetwork …]` forwards every facade to them                                                | not located yet              |
| `CreateMissionDataCipherKey` (free function)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `-[ChallengeMissionSheet initWithData:sheetID:]`/`generateSaveData` cipher the saved sheet with it   | not located yet              |
| `RecommendAdData (+getInterstitialSpecList)`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `+[RecommendDebug getFrequencyStatus/getDisplaySpec]` annotate their dictionaries from it            | not located yet              |
| `ApplilinkVideoController` (`-parentWindowFlag:`, `-view`, `-setSdkDelegate:`, `-setQuery:autoPlay:applilinkParams:delegate:`, `-viewDealloc`, `-willAnimateRotationToInterfaceOrientation:duration:`)                                                                                                                                                                                                                                                                                                                                                                        | `-[ApplilinkViewManager …]` owns and drives the in-app video player through it                       | not located yet              |
| `EditDataManager` (`+sharedManager`, `-getEditSlotLimit`, `-pickUpEditorInfoFromData:`, `-localSaveDLFile:serial:usrTag:`, `-getFileInfoList:`, `-setLastEditFileName:fileName:`)                                                                                                                                                                                                                                                                                                                                                                                             | `-[EditSystemMenuview …]` sizes the load section; `-[JcfDownloader …]` saves the downloaded chart    | not located yet              |
| `NSData (Base64)` (`+dataFromBase64String:`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `-[JcfDownloader jubeatLabAccessFinished:]` decodes the base64 chart data with it                    | not located yet              |
| `-[TweetResourceManager setInstallApplicationNum:]` (not on the reconstructed header)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | `+[GameNetworkUtil fillInstallAppNum:]` pushes the effective install count into it                   | not located yet              |
| `CDataScanner` (TouchJSON base scanner: `-scanCharacter:`, `-scanString:intoString:`, `-currentCharacter`, `-scanLocation`, `-userInfoForScanLocation`, and the `@protected char *current; char *end;` byte cursor)                                                                                                                                                                                                                                                                                                                                                           | `-[CJSONScanner …]` subclasses it and scans the byte cursor directly                                 | not located yet              |
