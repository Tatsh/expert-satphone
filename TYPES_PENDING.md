...
| `ChallengeTextInputView` (`initWithFrame:`, `nameBox`, `changeBtn`, `setDefaultText:`, `setADelegate:`, `inputText`)                                  | `-[ChallengeNameSettingView initWithFrame:]` builds and drives one                      | not located yet              |
