...
| `ChallengeListView` (`initWithFrame:listPosY:`, `setTitleImage:animation:`, `setListArray:`, `setADelegate:`)                                         | `-[ChallengeRivalListView downloaderFinished:]` builds and drives one                   | referenced via 0x3487f0 PTR  |
