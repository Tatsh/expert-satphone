...
| `ChallengeMissionSheet` (`-sheetName`, `-missionTable` returning `NSArray<ChallengeMissionTerms *> *`)                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | `+[MissionAchievementMessage createTitleArray:achieve:]` walks the sheets and their terms            | 0x288417 (class name string) |
