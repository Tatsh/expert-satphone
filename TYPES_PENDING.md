...
| `RecommendNetwork` (`openAdAreaWithParentView:rect:adModel:adLocation:verticalAlign:delegate:`, `closeAdAreaWithParentView:`) — the class has 21 methods, only these two are declared here                                                                        | `-[SettingsRecommendViewController …]` opens and closes the recommend ad area through them           | 0x352078 (class)             |
