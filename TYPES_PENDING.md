...
| `ChallengePresentListView` (`initWithFrame:`, `setListArray:`, `setADelegate:`, and the table-view data source/delegate)                              | `-[ChallengePresentView handleListLoadResponse:status:]` builds and drives one          | 0x3515d8 (class)             |
